...
describe("SimpleOracle", () => {
    ...
    it("should throw error if context is not an array or undefined", () => {
        ...
        }).toThrow("actionIds, context, features must be arrays of strings or undefined.");
    });
    ...
    it("should throw error if contextInteractions is not an boolean", () => {
        ...
        }).toThrow("actionIdFeatures, actionFeatures, contextActionIdInteractions, contextActionFeatureInteractions, useInversePropensityWeighting must be booleans.");
    });
    beforeEach(() => {
    ...
    describe("constructor", () => {
        it("should create an instance of SimpleOracle with the correct properties", () => {
            ...
            expect(oracle.contextActionIdInteractions).toEqual(contextActionIdInteractions);
            expect(oracle.contextActionFeatureInteractions).toEqual(contextActionFeatureInteractions);
    ...
    describe("fromOracleState", () => {
        it("should return an instance of LogisticOracle with the correct properties", () => {
            ...
            const newOracle = SimpleOracle_1.SimpleOracle.fromOracleState(oracleState);
            ...
            expect(newOracle.contextActionIdInteractions).toEqual(contextActionIdInteractions);
            expect(newOracle.contextActionFeatureInteractions).toEqual(contextActionFeatureInteractions);
            expect(newOracle.useInversePropensityWeighting).toEqual(useInversePropensityWeighting);
    ...
    describe("__getModelInputsWeightsAndLogit", () => {
        it("should return the correct model inputs and weights with empty weights", () => {
            ...
            const { inputs, weights, logit } = oracle._getModelInputsWeightsAndLogit(actionId, context, features);
    ...
    describe("fromJSON", () => {
        it("should return an instance of LogisticOracle with the correct properties", () => {
            const newOracle = SimpleOracle_1.SimpleOracle.fromJSON(oracle.toJSON());
            expect(newOracle.actionIds).toEqual(actionIds);
            expect(newOracle.context).toEqual(context);
            expect(newOracle.features).toEqual(features);
            expect(newOracle.learningRate).toEqual(learningRate);
    ...
    describe("fit", () => {
        it("should return an array of weights that are different from the previous weights", () => {
            const oracle = new SimpleOracle_1.SimpleOracle({ learningRate: 1, laplaceSmoothing: 0 });
            const trainingData = {
            ...
            const oldWeights = Object.assign({}, oracle.weights);
