...
class SimpleOracle {
    constructor({ actionIds = undefined, context = undefined, features = undefined, learningRate = 0.1, regularizer = 0.0, actionIdFeatures = true, actionFeatures = true, contextActionIdInteractions = true, contextActionFeatureInteractions = true, useInversePropensityWeighting = true, laplaceSmoothing = 0.01, targetLabel = "click", name = undefined, oracleWeight = 1.0, weights = {}, } = {}) {
        ...
        if (typeof regularizer !== "number" || regularizer < 0) {
            throw new Error("Invalid argument: regularizer must be a positive number.");
        }
        if (typeof laplaceSmoothing !== "number" || laplaceSmoothing < 0) {
            throw new Error("Invalid argument: laplaceSmoothing must be a positive number.");
        }
    ...
    fit(trainingData) {
        ...
        for (const data of trainingData) {
            if (data[this.targetLabel] !== undefined) {
                ...
                let sampleWeight = data.sampleWeight !== undefined ? data.sampleWeight : 1.0;
